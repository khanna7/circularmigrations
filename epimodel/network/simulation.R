...
formation <- ~edges + nodemix("type", base = c(-1))
...
control <- control.net(type="SI", nsims = 1, nsteps = 25, deaths.FUN = deaths, births.FUN = births, infection.FUN = infection, migration.FUN = migration, get_prev.FUN = get_prev, depend = TRUE)
